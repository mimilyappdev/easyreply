...
import { defaultData } from './data/defaultData_ja.js'
...
document.getElementById('settings-import-input').addEventListener('change', (e) => {
  ...
  reader.onload = (ev) => {
    try {
      ...
      storage.setItem('er_data_ja', JSON.stringify(data))
      location.reload()
    } catch {
